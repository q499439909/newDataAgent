...
4. 建立 PipelineVersion、OperatorExampleSet 和 NodePreviewSet；
5. 接入 FastAPI 和 PostgreSQL；
6. 建立四 Agent 子图和 LangGraph 主图；
7. 将任务执行迁入 Worker；
8. 接入独立 Evaluator、训练反馈和闭环路由；
9. 完成 Web 工作台、图片版本预览和批量审核；
